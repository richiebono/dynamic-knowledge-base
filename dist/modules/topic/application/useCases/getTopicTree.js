...
exports.GetTopicTree = void 0;
const inversify_1 = require("inversify");
let GetTopicTree = class GetTopicTree {
    ...
    async buildTopicTree(topic) {
        ...
        topic.subTopics = await Promise.all(subTopics.map(subTopic => this.buildTopicTree(subTopic)));
        return topic;
    }
};
GetTopicTree = __decorate([
