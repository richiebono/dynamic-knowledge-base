...
let CreateTopic = class CreateTopic {
    constructor(topicRepository) {
        this.topicRepository = topicRepository;
    }
    async execute(topicDTO) {
        const topic = new topic_1.Topic(topicDTO.id, topicDTO.name, topicDTO.content, new Date(), new Date(), 1, // Initial version
